const IcoLogo = () => (
  ...
  >
    ...
    <g fill="#231F20" opacity=".2">
      <path d="m40 40v-23.816c-1.163 0.413-2 1.512-2 2.816v25h2v-4z" />
      <path d="m26 40v-17c0-1.304-0.837-2.403-2-2.816v23.816h2v-4z" />
    </g>
    <path
      d="m35 12h-6c-1.657 0-3 1.343-3 3v29h12v-29c0-1.657-1.343-3-3-3z"
      fill="#4F5D73"
    />
    <rect x="26" y="16" width="12" height="3" fill="#76C2AF" />
    <rect x="26" y="37" width="12" height="3" fill="#76C2AF" />
  </svg>
)
